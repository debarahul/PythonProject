      ...
      #  print(field1)
        ...
        if payload_path == None:
            ...
            try:
                ...
                '''
                if str(expected[3]) == "vis":
                    try:
                        if Type_of_TC == 'Positive':
                            status = functions.vis_comparison(expected,payload_path)
                        else:
                ...
                elif str(expected[3]) == "timeout":
                    try:
                        if Type_of_TC == 'Positive':
                            status = functions. Negativetestcase1_comparision(expected,payload_path)
                        else:
                            print("Negative testcases")
                    except:
                            print("Getting no resposnse from nfdb")
                    ...
                    try:
                        if Type_of_TC == 'Positive':
                            status = functions.get_comparision(expected,payload_path)
                        else:
                            print("Negative testcases")
                    except:
                            print("Getting no resposnse from nfdb")
                    ...
                    try:
                        if Type_of_TC == 'Positive':
                            status = functions.comparison1(expected,payload_path)
                        else:
                            print("Negative testcases")
                    except:
                            print("Getting no resposnse from nfdb")
